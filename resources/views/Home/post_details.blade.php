      ...
      <div class="col-lg-8 mb-5 mb-lg-0 order-0 order-lg-1">
        ...
        <div class="post">
          ...
          <div class="post-media post-image">
            <img loading="lazy" src="/postimage/{{$post->image}}" class="img-fluid" alt="post-image">
          </div>
          ...
          <div class="post-body">
            <div class="entry-header">
              <div class="post-meta">
                <span class="post-author">
                  <i class="far fa-user"></i><a href="#"> {{$post->created_at}}</a>
                </span>
                <span class="post-cat">
                  <i class="far fa-folder-open"></i><a href="#"> News</a>
                </span>
                <span class="post-meta-date"><i class="far fa-calendar"></i> {{$post->title}}</span>
                <span class="post-comment"><i class="far fa-comment"></i> 03<a href="#"
                    class="comments-link">Comments</a></span>
              </div>
              <h2 class="entry-title">
                <a href="https://www.linkedin.com/feed/update/urn:li:activity:7139947466795237378">{{$post->title}}</a>
              </h2>
            </div><!-- header end -->
            ...
            <div class="post-footer">
              <a href="{{url('all_blogs')}}" class="btn btn-primary">More projects</a>
            </div>
